...
print("2) Make sure that the adapter is connected to a network")
print("##############################################################\n")
...
mac_to_change_to = ["9843FA283C14", "D017C28A8E47", "021122334455", "061122334455"]
...
#I made some mortification here can let user choose which device they want to restart 
...
for adapter in network_adapters:
    print(adapter)
run_disable_enable = input("Which device you would like to resart? click 'N' if you dont want to restart.")
if run_disable_enable.lower() != "n":
    adapter = network_adapters[int(run_disable_enable)+1]
